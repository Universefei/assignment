...
/******************************************************************************
 *                                                                            *
 *                          compress implementations                          *
 *                                                                            *
 *****************************************************************************/

// Helper functions
std::string 
generate_code(std::string plaintext, const tree &t);
...
/*----- getplain() ----------------------------------------------------------*/
void 
decompress::getplain(const tree &hc)
{
